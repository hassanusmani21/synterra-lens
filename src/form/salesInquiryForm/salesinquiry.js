...
export const SalesInquiry = () => {
  ...
  return (
    <Container>
      <Header title="SalesInquiry" subtitle="Create a New User Profile" />
        ...
        >
          ...
          <Grid item xs={4}>
            ...
            <TextField
              ...
              type='number'
              placeholder='approvedDisapproved'
          ...
          <Grid item xs={4}>
            <Typography>factoryUnitId:</Typography>
            <TextField
              variant="outlined"
              fullWidth
              name="factoryUnitId"
              type='text'
              placeholder='Factory UnitId'
